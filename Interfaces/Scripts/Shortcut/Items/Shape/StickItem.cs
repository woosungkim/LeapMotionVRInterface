...
public class StickItem : ShapeItem {
	...
	public override void Build (ShortcutSettings sSettings, GameObject parentObj)
	{
		...
		_width = _iSettings.ItemWidth;
		_height = _iSettings.ItemHeight;
	...
	public override void Rendering() {
		...
		labelObj.transform.localPosition = new Vector3(0, _iSettings.ItemHeight/2, 0);
		...
		case (ItemType.Parent) :
			...
			labelHasChildObj.transform.localPosition = new Vector3(_iSettings.ItemWidth, _iSettings.ItemHeight/2, 0);
